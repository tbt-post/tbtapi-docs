...
[source, shell]
----
curl -v -X GET "https://sandbox-api.tbt-post.net/api/v1/op/entity?code=$EC$F0:0006$" \
-H "Content-Type: application/json" \
-b cookie-jar1.txt
----
...
[source, shell]
----
curl -v -X POST "https://sandbox-api.tbt-post.net/api/v1/op/entity/reparent/95112660-f50e-4b7c-8b81-92139cda3aa4" \
-H "Content-Type: application/json" \
-b cookie-jar1.txt \

...
method_params:: <PARCEL ID>
request_body:: { "receiver": { "id": "<EXT User ID>", "phone": "<PHONE 380XXYYYYYYY>", "email" : "<USER EMAIL>", "first name" : "<FIRST NAME>", "last_name": "<LAST NAME>"}, "price" : <PRICE as DECIMAL(10,2)>, "cod_amount" : <PRICE as DECIMAL(10,2)>, "items": [<PARCEL ITEM SPEC>, ...]}
expected_result:: 202 {"success": true}
...
> -H "Content-Type: application/json" \
> -H "Authorization: Basic dG9rZW46cGFzc3dk" \
> -d '{"price" : 5, "cod_amount" : 5, "items": [{"barcode": "123456789", "sku": "123456", "name": "shoes", "brand": "NoBrand", "size": "45", "quantity": 1, "weight": 50, "price": 99.99, "photos":["https://example.com/images/test.jpg"], "color": "black"}]}'
...
NOTE: Параметры в [ ] опциональны. По умолначию lang=uk.

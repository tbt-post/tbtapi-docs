...
https://github.com/tbt-post/edi-receiver[EDI Receiver] (please, follow https://github.com/tbt-post/tbtapi-docs/tree/master/edi/json-schema[EDI] https://github.com/tbt-post/tbtapi-docs/releases/latest[versioning])
